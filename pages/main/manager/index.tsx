...
const ManagerPage = () => {
  ...
  const linkInfo = {
    newTab: 1,
    link: 'http://localhost:4200/main/manager',
    name: 'name2',
  };
  return (
...
// const isStudent = (_: Course, role: Role, session: Session) =>
//   role === 'student' || session.isAdmin;
...
//       combineOr(isMentor, isTaskOwner, isAdminRole, isCourseManager)
//     ),
//   },
//   {
//     name: () => (
...
//       .filter(
//         (course) =>
//           isAdmin || session.roles[course.id] || !isEmpty(session.coursesRoles?.[course.id])
//       )
//       .filter(
//         (course) =>
//           !(!isAdmin && course.alias === 'epamlearningjs' && session.roles[course.id] === 'student')
//       )
...
//     const wasMentor = true//Object.values(this.props.session.roles).some((v) => v === 'mentor');

//     const plannedCourses = (this.props.courses || []).filter(
//       (course) => course.planned && !course.inviteOnly
//     );
...
//     //   this.loadCourseData(activeCourse?.id),
//     // ]);
...
//                 size="small"
//                 type="link"
//                 href="https://docs.rs.school/#/how-to-enroll"
//               >
//                 More info
//               </Button>
//             </span>
...
//   render() {
//     const { isAdmin, coursesRoles } =[ true, 'Admin'] //this.props.session;
//     const isCourseManager = true//values(coursesRoles).some((item) => item?.includes('manager'));
//     const activeCourse = this.getActiveCourse();
//     const courses = this.getCourses();
//     return (
//       <div>
//         <Layout style={{ minHeight: '100vh' }}>
//            {/* {(isAdmin || isCourseManager) && (
//            <AdminSider isAdmin={isAdmin} isCourseManager={isCourseManager} />
//           )} */}
...
// export default IndexPage; //withCourses(withSession(IndexPage));
